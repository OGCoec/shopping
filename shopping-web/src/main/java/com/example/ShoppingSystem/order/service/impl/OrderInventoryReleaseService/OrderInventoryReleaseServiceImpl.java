package com.example.ShoppingSystem.order.service.impl.OrderInventoryReleaseService;
...
@Service
public class OrderInventoryReleaseServiceImpl implements OrderInventoryReleaseService {

    private final Map<OrderInventoryType, OrderInventoryStrategy> inventoryStrategies;

    public OrderInventoryReleaseServiceImpl(List<OrderInventoryStrategy> strategies) {
