package com.example.ShoppingSystem.order.service.impl.OrderPaymentExpireCheckService;
...
import com.example.ShoppingSystem.order.service.PaymentStatusQueryStatus;
@Service
public class OrderPaymentExpireCheckServiceImpl implements OrderPaymentExpireCheckService {
    ...
    public OrderPaymentExpireCheckServiceImpl(OrderRedisSnapshotService orderRedisSnapshotService,
