package com.example.ShoppingSystem.order.service.impl.PaymentCallbackPendingMarkerService;
...
@Service
public class PaymentCallbackPendingMarkerServiceImpl implements PaymentCallbackPendingMarkerService {

    private final StringRedisTemplate stringRedisTemplate;
    private final PaymentCallbackStreamProperties properties;

    public PaymentCallbackPendingMarkerServiceImpl(StringRedisTemplate stringRedisTemplate,
