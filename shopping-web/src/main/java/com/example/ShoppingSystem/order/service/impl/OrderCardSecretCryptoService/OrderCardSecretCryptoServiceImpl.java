package com.example.ShoppingSystem.order.service.impl.OrderCardSecretCryptoService;
...
@Service
public class OrderCardSecretCryptoServiceImpl implements OrderCardSecretCryptoService {
    ...
    public OrderCardSecretCryptoServiceImpl(AdminManagedEnvService managedEnvService) {
