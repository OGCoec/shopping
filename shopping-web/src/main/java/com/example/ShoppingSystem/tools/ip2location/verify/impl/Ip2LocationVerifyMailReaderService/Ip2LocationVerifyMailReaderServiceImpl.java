package com.example.ShoppingSystem.tools.ip2location.verify.impl.Ip2LocationVerifyMailReaderService;
 ...
 */
@Service
public class Ip2LocationVerifyMailReaderServiceImpl implements Ip2LocationVerifyMailReaderService {
    ...
    @Autowired
    public Ip2LocationVerifyMailReaderServiceImpl(
    ...
    private Ip2LocationVerifyMailReaderServiceImpl(ObjectMapper objectMapper,
    ...
    public Ip2LocationVerifyMailReaderServiceImpl(ObjectMapper objectMapper,
                                       HttpClient httpClient,
                                       String tokenUrl,
                                       String imapHost,
                                       int imapPort,
