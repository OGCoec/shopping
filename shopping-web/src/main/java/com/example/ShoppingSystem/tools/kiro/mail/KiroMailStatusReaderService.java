...
@Service
public class KiroMailStatusReaderService {
    ...
    @Autowired
    public KiroMailStatusReaderService(
    ...
    public record KiroMailStatusScanResult(String status,
        ...
        private static KiroMailStatusScanResult failed(String status, String reason, String imapRoute) {
            return new KiroMailStatusScanResult(
                    status,
                    reason,
                    false,
