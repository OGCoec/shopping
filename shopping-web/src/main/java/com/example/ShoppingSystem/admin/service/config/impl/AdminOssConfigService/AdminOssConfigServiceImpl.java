package com.example.ShoppingSystem.admin.service.config.impl.AdminOssConfigService;
...
@Service
public class AdminOssConfigServiceImpl implements AdminOssConfigService {
    ...
    public AdminOssConfigServiceImpl(ConfigurableEnvironment environment,
