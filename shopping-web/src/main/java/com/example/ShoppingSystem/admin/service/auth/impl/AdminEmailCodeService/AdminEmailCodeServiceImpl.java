package com.example.ShoppingSystem.admin.service.auth.impl.AdminEmailCodeService;
...
public class AdminEmailCodeServiceImpl implements AdminEmailCodeService {
    ...
    public AdminEmailCodeServiceImpl(StringRedisTemplate stringRedisTemplate,
