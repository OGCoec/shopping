...
@Service
public class AdminCardSecretInventoryService {
    ...
    public AdminCardSecretInventoryService(CardSecretInventoryMapper cardSecretInventoryMapper,
    ...
    public AdminCardSecretImportResponse importSecrets(Long spuId,
        ...
        if (!booleanValue(result == null ? null : result.get("skuExists"))) {
            throw new AdminServiceException(
        ...
        int skuStockQuantity = intValue(result == null ? null : result.get("skuStockQuantity"));
