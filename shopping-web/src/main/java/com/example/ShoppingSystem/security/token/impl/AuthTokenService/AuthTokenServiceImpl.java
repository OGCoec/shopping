package com.example.ShoppingSystem.security.token.impl.AuthTokenService;
...
import com.example.ShoppingSystem.security.token.RefreshSession;
@Service
public class AuthTokenServiceImpl implements AuthTokenService {
    ...
    public AuthTokenServiceImpl(JwtUtils jwtUtils,
    ...
    public void logoutAllDevices(Long userId, HttpServletRequest request, HttpServletResponse response) {
        ...
        routedTransactionExecutor.executeWithoutResult(DataSourceRoute.CORE, () -> {
