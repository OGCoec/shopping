package com.example.ShoppingSystem.filter.preauth.impl.PreAuthBindingService;
 ...
 */
@Service
public class PreAuthBindingServiceImpl implements PreAuthBindingService {
     ...
     */
    public PreAuthBindingServiceImpl(PreAuthProperties properties,
