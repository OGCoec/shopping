package com.example.ShoppingSystem.filter.preauth.domain.impl.PreAuthRiskStateSyncService;
 ...
 */
@Service
public class PreAuthRiskStateSyncServiceImpl implements PreAuthRiskStateSyncService {
    ...
    public PreAuthRiskStateSyncServiceImpl(StringRedisTemplate stringRedisTemplate,
