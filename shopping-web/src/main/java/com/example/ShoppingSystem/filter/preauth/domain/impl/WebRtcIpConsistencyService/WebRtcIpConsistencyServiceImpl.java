package com.example.ShoppingSystem.filter.preauth.domain.impl.WebRtcIpConsistencyService;
...
@Service
public class WebRtcIpConsistencyServiceImpl implements WebRtcIpConsistencyService {
    ...
    public WebRtcIpConsistencyServiceImpl(PreAuthProperties properties,
