package com.example.ShoppingSystem.quota.impl.DeviceLinkedUserCountQueryService;
...
import com.example.ShoppingSystem.quota.DeviceLinkedUserCountQueryService;
import com.example.ShoppingSystem.quota.DeviceRiskLocalCacheStore;
/**
 * Multi-level lookup pipeline for the number of users linked to one device.
 */
@Service
public class DeviceLinkedUserCountQueryServiceImpl implements DeviceLinkedUserCountQueryService {
    ...
    public DeviceLinkedUserCountQueryServiceImpl(DeviceRiskLocalCacheStore localCacheStore,
