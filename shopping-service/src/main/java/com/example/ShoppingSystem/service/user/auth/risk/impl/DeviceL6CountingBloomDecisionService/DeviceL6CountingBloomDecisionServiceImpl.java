package com.example.ShoppingSystem.service.user.auth.risk.impl.DeviceL6CountingBloomDecisionService;
 ...
 */
@Service
public class DeviceL6CountingBloomDecisionServiceImpl implements DeviceL6CountingBloomDecisionService {
    ...
    public DeviceL6CountingBloomDecisionServiceImpl(CountingBloomFilter countingBloomFilter) {
