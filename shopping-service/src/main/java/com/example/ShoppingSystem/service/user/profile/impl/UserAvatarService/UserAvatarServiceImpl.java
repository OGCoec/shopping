package com.example.ShoppingSystem.service.user.profile.impl.UserAvatarService;
...
public class UserAvatarServiceImpl implements UserAvatarService {
    ...
    public boolean deleteAvatar(Long userId) {
        ...
        return Boolean.TRUE.equals(routedTransactionExecutor.execute(DataSourceRoute.CORE, () -> {
