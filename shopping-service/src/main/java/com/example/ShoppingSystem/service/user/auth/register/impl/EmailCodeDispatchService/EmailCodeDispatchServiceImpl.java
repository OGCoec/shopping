package com.example.ShoppingSystem.service.user.auth.register.impl.EmailCodeDispatchService;
 ...
 */
@Service
public class EmailCodeDispatchServiceImpl implements EmailCodeDispatchService {

    private final StringRedisTemplate stringRedisTemplate;
    private final RegisterEmailCodeMessagePublisher registerEmailCodeMessagePublisher;
    private final PasswordEncoder passwordEncoder;

    public EmailCodeDispatchServiceImpl(StringRedisTemplate stringRedisTemplate,
