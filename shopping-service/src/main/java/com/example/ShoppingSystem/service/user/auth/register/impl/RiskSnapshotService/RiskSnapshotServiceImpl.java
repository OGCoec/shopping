package com.example.ShoppingSystem.service.user.auth.register.impl.RiskSnapshotService;
...
public class RiskSnapshotServiceImpl implements RiskSnapshotService {
    ...
    public RiskSnapshotServiceImpl(AuthRiskSnapshotService authRiskSnapshotService,
