package com.example.ShoppingSystem.service.user.auth.risk.impl.AutomationRiskGateService;
...
public class AutomationRiskGateServiceImpl implements AutomationRiskGateService {
    ...
    private void applyIpPenalty(String publicIp, int penaltyScore, String reason) {
        ...
        try {
            ...
            Integer updatedScore = routedTransactionExecutor.execute(DataSourceRoute.RISK, () -> normalizedIp.contains(":")
