package com.example.ShoppingSystem.service.user.auth.login.impl.LoginChallengeSessionService;
...
@Service
public class LoginChallengeSessionServiceImpl implements LoginChallengeSessionService {
    ...
    public LoginChallengeSessionServiceImpl(StringRedisTemplate stringRedisTemplate) {
